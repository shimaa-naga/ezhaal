        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  action="{{ route('master.work_method.lang.store') }}" method="post" class="form-horizontal"  id="lang_submit" data-parsley-validate="">
                        @csrf
                        ...
                        <div class="box-body">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="titletrans" class="form-control" name="title" required="" placeholder="{{_i('Please Enter Title')}}">
                                </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                <textarea id="description_trans" class="textarea form-control" name="description" required=""
...
@push('js')
    <script>
        ...
        $('body').on('click','.lang_ex',function (e) {
            ...
            $.ajax({
                url: '{{ route('master.work_method.lang') }}',
                method: "get",
                data: {
                    lang_id: lang_id,
                    id: id,
