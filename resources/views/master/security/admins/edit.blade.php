@extends('master.layout.index' ,['title' => _i('Edit Admin')])
...
@section('content')
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ _i('Edit Admin') }}</li>
        </ol>
    </div>
    <!--breadcrumbs end -->
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('master.admins.update', $user->id) }}" class="form-horizontal"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input id="last_name" type="text"
                                        ...
                                        name="last_name" value="{{ $user->last_name }}" data-parsley-maxlength="191">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="button" class="btn btn-warning col-sm-3" data-toggle="modal"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input id="password" type="password"
                                    ...
                                    name="password" value="{{ old('password') }}" required="" min="6" data-parsley-min="6"
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.is_active == 1) {
                        ...
                        $('.show_button_status').append(
                            '<form method="Post" action="{{ route('master.admins.changeStatus') }}" class="status_button disaple_form" style="display: inline">' +
