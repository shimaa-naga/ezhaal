        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  action="{{ route('master.blogs.lang.store') }}" method="post" class="form-horizontal"  id="lang_submit" data-parsley-validate="" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="blog_id" id="id_data" value="">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group ">
                                <div class="row">
                                <label class="col-sm-2 col-form-label" for="contenttrans">{{_i('Content')}} </label>
                                <div class="col-sm-10">
                                    <textarea class="wysihtml5 form-control" id="contenttrans" name="content_blog" rows="10"></textarea>
                                </div>
                                </div>
                            </div>
                            <div class="form-group ">
...
@push('js')
    <script>
                ...
                success: function (response) {
                    if (response.data == false){
                       ...
                       $("#old_imgtrans").attr("src", "{{asset('custom/index.png')}}");
                        ...
                        $('#contenttrans').val(response.data.content);
                    }
                }
            });
        ...
        function showImgTrans(input) {
            ...
            filereader.onload = (e) => {
                //console.log(e);
                $("#old_imgtrans").attr('src', e.target.result).width(100).height(100);
            };
