...
@extends('master.layout.index' ,['title' => _i('Cities')])

@section('content')
    <!--breadcrumbs start -->
    <div class="page-header">
        <h4 class="page-title">{{ _i('Cities') }}</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('MasterHome') }}"><i class="fa fa-home"></i> {{ _i('Home') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ _i('Cities') }}</li>
        </ol>
    </div>
    <!--breadcrumbs end -->
                ...
                <div class="card-header">
                    <div class="card-title">
                        <a href="#" class='btn btn-shadow btn-primary mb-2 text-white' data-toggle='modal' data-target='#add-Modal'>
                            <i class="fa fa-plus"> </i> {{ _i('Create new City') }}
                        </a>
                    </div>
                </div>
                <div class="card-body">
    ...
    <!-- page end-->
@include('master.city.create')
@include('master.city.edit')
@include('master.city.trans')
@endsection
