    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" > {{_i('Edit project status')}} </h4>
            </div>
                ...
                <form id="form_edit" class="form-horizontal" method="POST" data-parsley-validate="" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" id="status_title" required=""  placeholder="{{_i('Please Enter Project Status Title')}}">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(function() {
            $('#form_edit').submit(function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('master.proj_status.update') }}",
                    type: "POST",
