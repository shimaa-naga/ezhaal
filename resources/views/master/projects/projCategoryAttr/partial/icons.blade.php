<select class="form-control select2-show-search" name="icon" id="icon">
    <option value='' selected>{{_i("Select icon")}}</option>
    ...
    <option value='fa-thermometer-three-quarters'>&#xf2c8; fa-thermometer-three-quarters
    </option>
...
@push('js')
    ...
    <script type="text/javascript">
        function formatText(icon) {
            return $('<span><i class="fa ' + $(icon.element).val() + '"></i> ' + icon.text + '</span>');
        };
