	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
                <h5 class="modal-title">{{ _i('Create new complaint status') }}</h5>
			...
			<div class="modal-body">
                ...
                <div class="form-group ">
                    <div class="row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="title" id="title" required=""  placeholder="{{_i('Please Enter Complaint Status Title')}}">
						</div>
                    </div>
					</div>
			</div>
