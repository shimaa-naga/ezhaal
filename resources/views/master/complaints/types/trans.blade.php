        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  action="{{ route('master.complaint_type.lang.store') }}" method="post" class="form-horizontal"  id="lang_submit" data-parsley-validate="">
                        @csrf
                        ...
                        <div class="box-body">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="titletrans" class="form-control" name="title" required="" placeholder="{{_i('Please Enter Complaint Type Title')}}">
                                </div>
                                </div>
                            </div>
                        </div>
...
@push('js')
    <script>
        $('body').on('click','.lang_ex',function (e) {
            ...
            $.ajax({
                url: '{{ route('master.complaint_type.lang') }}',
                method: "get",
                data: {
                    lang_id: lang_id,
                    id: id,
